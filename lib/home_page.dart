                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                          child: Column(
                            ...
                            children: <Widget>[
                              Text('${_brand[index]}',style: kRegularTextStyle,),
                              Text('${_item[index]}', overflow:TextOverflow.ellipsis,style: kTitleTextStyle,),
                              Text('\$${_price[index]}', style: kRegularTextStyle,),
                            ],
                          ),
                        ),
                      ],
